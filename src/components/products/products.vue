    ...
    <div class="top_box flex-j-c">
      <div class="flex-j-sb top_nav">
        <div class="flex-cent">
          ...
          <div class="position">{{location}}</div>
      ...
      <div class="mid">
        ...
        <div>
          <div class="search_box">
            <input type="text" placeholder="搜索商家或地点" v-model="keywords" @keydown.enter="send" />
...
export default {
  ...
  methods: {
    ...
    send() {
      this.$router.push({
        path: "/search",
        query: { keyword: this.keywords, city: this.location },
      });
    },
    sends(name) {
      this.$router.push({
        path: "/search",
        query: { keyword: name, city: this.location },
      });
    },
